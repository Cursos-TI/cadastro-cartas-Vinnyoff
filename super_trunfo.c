...
int main()
{
    ...
    // int vencedor_populacao        = (população1 > população2);
    // int vencedor_area             = (area1 > area2);
    // int vencedor_pib              = (pib1 > pib2);
    // int vencedor_npt              = (npt1 > npt2);
    // int vencedor_pib_per_capita   = (pib_per_capita1 > pib_per_capita2);
    // int vencedor_densidade        = (densidade1 < densidade2); // menor vence
    // int vencedor_super_poder      = (poder1 > poder2);
